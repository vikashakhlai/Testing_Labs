...
public class AddToFavourites {
    ...
    public void Favourites() throws InterruptedException {
        ...
        driver.get("https://www.ellesse.com/mk-x-ellesse-monroe-nylon-gabardine-and-leather-trainer/13810041.html");
        logger.info("Open product page");

        Thread.sleep(2000);
        ellesseHomePage.FindElementAndClick("/html/body/main/div[3]/div[2]/div/div[5]/div/div[1]/button");
