...
public class ChangeCountProductOfCart {
    ...
    @Test(description = "Change Count Product")
    public void Compare() throws InterruptedException {
        ...
        driver.get("https://www.ellesse.com/my.basket");
        logger.info("Open basket");

        Thread.sleep(5000);
        ellesseHomePage.FindElementAndClick("/html/body/main/div[2]/div[1]/ul/li/div[2]/div[3]/div[4]/div[1]/a");
        logger.info("change cout of product");
    }
